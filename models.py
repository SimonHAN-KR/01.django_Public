...
class Category(models.Model):
    category_code = models.IntegerField(primary_key=True, db_index=True)
...
class Corporation(models.Model):
    ...
    category_code = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name='corporations')
